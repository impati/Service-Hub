insert into client (sub,nickname,username,email,role_type,provider_type,blog_url,profile_image_url,introduce_comment,created_by,created_at,updated_at) values ('80f7f0c0-5449-4e2b-9422-da1c8cdfbd24','성급한','impati','sinms1116@naver.com','ADMIN','KEYCLOAK','https://github.com/impati','http://impatient.iptime.org:9090/file/profile/default.png','hi i am impati','성급한',now(),now());
insert into client (sub,nickname,username,email,role_type,provider_type,blog_url,profile_image_url,introduce_comment,created_by,created_at,updated_at) values ('5c6a008d-0ce5-415f-86db-243671a0d659','wnsduds1','wnsduds1','wnsduds1@sju.ac.kr','USER','KEYCLOAK','https://www.notion.so/impati-Log-fdd5d1e7465f41a1b25fe4a7b5b7880d','http://impatient.iptime.org:9090/file/profile/default.png','hi i am wnsduds1','wnsduds1',now(),now());
...
insert into services (logo_store_name, service_url,service_name,title,content,created_by,created_at,updated_at) values ('9e938eaa-090d-49de-ab17-30228c6c2359.png','https://papago.naver.com/','파파고','무료 번역 서비스.','국내 최고 무료 번역 서비스.','impati',now(),now());
insert into services (logo_store_name, service_url,service_name,title,content,created_by,created_at,updated_at) values ('9bb5d2e6-19f6-4034-9928-885aaae2b5d3.png','https://getbootstrap.com/','부트스트랩','css 프레임워크.','css 프레임워크.','impati',now(),now());
insert into services (logo_store_name, service_url,service_name,title,content,created_by,created_at,updated_at) values ('1b711634-70a8-4907-8c25-f3343193b9d5.png','https://cloud.google.com/','Google Cloud','Cloud Computing Services  |  Google Cloud','구글 클라우드 컴퓨팅 서비스.','impati',now(),now());
insert into services (logo_store_name, service_url,service_name,title,content,created_by,created_at,updated_at) values ('e93b4c82-b4ad-414b-bd96-069561e9bb77.png','https://aws.amazon.com/','Amazon Web Services','Cloud Computing Services - Amazon Web Services (AWS)','아마존 클라우드 컴퓨팅 서비스.','impati',now(),now());
insert into services (logo_store_name, service_url,service_name,title,content,created_by,created_at,updated_at) values ('f2861af9-a09b-47dd-b229-6b8f931c7243.jpeg','https://azure.microsoft.com/','Microsoft Azure','클라우드 컴퓨팅 서비스 | Microsoft Azure','Microsoft 클라우드 컴퓨팅 서비스 Azure.','impati',now(),now());
insert into services (logo_store_name, service_url,service_name,title,content,created_by,created_at,updated_at) values ('6718c6a9-e26a-44c2-9656-ba874010b897.jpg','https://www.inflearn.com/','인프런','인프런 - 미래의 동료들과 함께 성장하는 곳 | IT 정보 플랫폼','IT 정보 플랫폼','impati',now(),now());
...
insert into service_category(service_id,category_id,created_by,created_at,updated_at) values(8,8,'impati',now(),now());
insert into service_category(service_id,category_id,created_by,created_at,updated_at) values(9,9,'impati',now(),now());
insert into service_category(service_id,category_id,created_by,created_at,updated_at) values(10,10,'impati',now(),now());
insert into service_category(service_id,category_id,created_by,created_at,updated_at) values(11,10,'impati',now(),now());
insert into service_category(service_id,category_id,created_by,created_at,updated_at) values(12,10,'impati',now(),now());
insert into service_category(service_id,category_id,created_by,created_at,updated_at) values(13,6,'impati',now(),now());
insert into service_category(service_id,category_id,created_by,created_at,updated_at) values(13,1,'impati',now(),now());
