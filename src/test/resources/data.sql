insert into client (sub,nickname,username,email,role_type,provider_type,created_by,created_at,updated_at) values ('312','성급한','impati','yongs170@naver.com','ADMIN','KEYCLOAK','성급한',now(),now());
