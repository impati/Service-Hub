insert into client (nickname,password,username,email,roles,created_by,created_at,updated_at) values ('impati','{noop}123','impati','yongs170@naver.com','ADMIN','impati',now(),now());
insert into client (nickname,password,username,email,roles,created_by,created_at,updated_at) values ('wnsduds1','{noop}123','wnsduds1','wnsduds1@sju.ac.kr','USER','wnsduds1',now(),now());
