...
class CustomerControllerTest {
	...
	void customerEditPageTest() throws Exception {
	...
	@WithMockCustomUser(id = 1L)
	void customerPageTest() throws Exception {
	...
	void customerEditTest() throws Exception {
		final CustomerEditForm editForm = new CustomerEditForm(
			"test",
			"hi",
	...
	@WithMockCustomUser
	void customerServiceEditPageTest() throws Exception {
		given(categoryAdminister.getAllCategories())
	...
	void deleteCustomerServiceTestIncludeCustomService() throws Exception {
	...
	@WithMockCustomUser(id = 2L)
	void addCustomerServiceTest() throws Exception {
	...
	void addCustomServiceTest() throws Exception {
		final CustomServiceForm form = CustomServiceForm.builder()
	...
	@WithMockCustomUser(id = 3L)
	void clickServiceTest() throws Exception {
