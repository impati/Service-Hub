...
class RequestServiceArticleRegisterTest {
    ...
    @Autowired
    RequestServiceArticleRepository repository;

    @Autowired
    RequestServiceArticleRegister register;

    @Test
    @DisplayName("서비스 요청 게시글 등록 테스트")
    public void givenRequestServiceInfo_whenRegisteringRequestService_thenRegisterRequestService() throws Exception {
        // given
        RequestServiceArticleForm form = create();
    ...
    public void givenRequestServiceInfo_whenRegisteringRequestService_thenAssertFieldAfterRegister() throws Exception {
        // given
        RequestServiceArticleForm form = create();
        ...
        // then
        RequestServiceArticle response = repository
                .findAll()
                .stream()
                .findFirst()
                .get();
    ...
    private RequestServiceArticleForm create() {
        RequestServiceArticleForm form = new RequestServiceArticleForm();
