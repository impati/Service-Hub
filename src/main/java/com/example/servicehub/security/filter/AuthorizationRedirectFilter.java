...
public class AuthorizationRedirectFilter extends OncePerRequestFilter {
    ...
    private static final String DEFAULT_AUTHORIZATION_REQUEST_BASE_URI = "/customer-server/authorization";
    ...
    public AuthorizationRedirectFilter(CustomerServer customerServer) {
